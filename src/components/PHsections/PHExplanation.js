        ...
        <div className={innerClasses}>
          ...
          <div className="hero-content">
            ...
            <div className="container-xs reveal-from-bottom" data-reveal-delay="400">
              <p>
                A novel <span className='text-color-primary'>algebraic topology</span> approach that championed in protein-ligand binding affinity prediction.
              </p>
            ...
            <div className='container-sm reveal-from-bottom' data-reveal-delay="400">
              <div className='p-16 container-xs'>
                ...
                <p className='text-xs'>Performance comparison of different submissions on affinity ranking of 19 ligands having crystallographic poses in stage 2 of subchallenge 1 of <a href="https://link.springer.com/article/10.1007/s10822-018-0180-4"><span className='text-color-primary'>D3R grand challenge 3</span></a>. The <b>persistent homology</b> algorithm by <em>Nguyen et al. (2018)</em> is shown in <span style={{color: "red"}}>red</span>.</p>
              </div>
